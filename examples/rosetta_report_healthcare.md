...
_Generated at 2026-08-06T12:26:53.087176+00:00_
...
### 1. `billing_amount` — silent_contradiction (CRITICAL)
...
### 3. `length_of_stay` — silent_contradiction (HIGH)
...
### 4. `test_results~test_results_clean` — silent_contradiction (MEDIUM)
...
### 5. `patient_name` — silent_contradiction (MEDIUM)
